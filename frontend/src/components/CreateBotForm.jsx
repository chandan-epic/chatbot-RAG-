                ...
                <div className='flex'>
                    ...
                    {step === 2 && (
                        <div className="mb-4 w-[350px]">
                            ...
                            <p className='text-white text-xs mt-3'>Don't have api key <span><a className='text-blue-400' href='https://aistudio.google.com/app/apikey' target='_blank'rel='noopener noreferrer'>click here</a></span>  </p>
                            <div className="flex justify-between mt-4">
                                <button
                                    type="button"
                                    onClick={handlePrev}
                    ...
                    <div className="flex flex-col  ml-14 mt-20 ">
                        ...
                        {step===0 &&
                            <div className='mt-[100px] '>
                                ...
                                <p className='mt-3'> 🚀Please provide your chatbot details.</p>
                                <p className='mt-3'>✨Specify the domain of your chatbot working field</p>
                                <p className='mt-3'>✨Enter the short description about your Ai assistant</p>
                            </div>
                        }
                        {step===1 &&
                            <div className='mt-[100px] '>
                                <p className='text-xl'>Upload Custom Data</p>
                                <p className='mt-3'>✨Upload the data specific to chatbot in the format of pdf or txt</p>
                                <p className='mt-3'>🧨Specify the do's and don't of your chatbot in the cuations field</p>
                                <p className='mt-3'>📏Select the length of answers produced by the chatbot </p>
                            </div>
                        }
                        {step===2 &&
                            <div className='mt-[100px] '>
                                <p className='text-xl'>API key</p>
                                <p className='mt-4'> 🔑 Provide Gemini API key.</p>
                                <p></p>
                            </div>
                        }
